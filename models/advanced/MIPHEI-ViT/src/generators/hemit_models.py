...
try:
    ...
    from timm.models.vision_transformer import resample_patch_embed

try:
    from timm.layers import resize_rel_pos_bias_table
except ImportError:
    try:
        from timm.models.vision_transformer import resize_rel_pos_bias_table
    except ImportError:
        try:
            from timm.models.swin_transformer import resize_rel_pos_bias_table
        except ImportError:
            pass  
import math
